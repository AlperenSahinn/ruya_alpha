	...
	bool depthClipEnable)
{
	...
	pipelineRenderingCreateInfo.colorAttachmentCount = colorAttachments.size();
...
VkPipeline ruya::VulkanRasterizationPipeline::GetDeviceHandle() const
{
	return deviceHandle;
}

VkPipelineLayout ruya::VulkanRasterizationPipeline::GetPipelineLayout() const
{
